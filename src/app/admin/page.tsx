        ...
        {stats && stats.length > 0 && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {stats.map((stat: any) => (
              ...
              >
                <div
                  className={`inline-block px-3 py-1 rounded-lg text-sm font-semibold uppercase mb-2 ${getStatusColor(stat.status)}`}
                >
                  {stat.status}
                </div>
              ...
              <tbody className="divide-y divide-white/10">
                {filteredApplications.map((app) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-3 py-1 rounded-lg text-xs font-semibold uppercase ${getStatusColor(app.status)}`}
                      >
                        {app.status}
                      </span>
                    </td>
                    ...
                    <div className="space-y-1 text-white">
                      ...
                      <p>
                        ...
                        {Array.isArray(selectedApp.dietary_restrictions)
                          ...
                          : selectedApp.dietary_restrictions || "None"}
                      </p>
                      <p>
                        Race/Ethnicity:{" "}
                        {Array.isArray(selectedApp.race_ethnicity)
                          ? selectedApp.race_ethnicity.join(", ")
                          : selectedApp.race_ethnicity || "N/A"}
                      </p>
                    </div>
                  </div>
                </div>

...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#030c1b] via-[#0a1628] to-[#030c1b] px-4">
      <div className="max-w-md w-full space-y-8 bg-white/5 backdrop-blur-lg p-8 rounded-2xl border border-white/10">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-2">
            Welcome to RocketHacks
          </h1>
          <p className="text-gray-400">
            Sign in to submit your application or view your dashboard
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center px-4 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-white font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >

        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mb-12 sm:mb-16 animate-slide-up">
            <div className="glass-strong rounded-3xl p-6 sm:p-10 max-w-3xl mx-auto border-2 border-rh-yellow/30 shadow-2xl">
              ...
              <p className="text-base sm:text-lg leading-relaxed text-rh-white/90 mb-6 max-w-2xl mx-auto">
                Join us for Code & Create 2026! High school students will learn
          ...
          <div className="text-center mb-16 animate-slide-up">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-rh-white/90 max-w-4xl mx-auto px-4">
              An inspiring day where high school students discovered the power
              of programming, explored the University of Toledo&apos;s College
              of Engineering, and built their first interactive projects.
            </p>
          </div>
          ...
          <div className="mb-16 animate-fade-scale px-4">
            <div className="glass rounded-3xl p-4 sm:p-6 max-w-4xl mx-auto">
              ...
              <p className="text-center text-rh-white/70 text-xs sm:text-sm mt-4">
                High school developers showcasing their creativity during Code &
                Create 2025
              </p>
            </div>
          </div>
          ...
          <div className="text-center px-4">
            <div className="glass-strong rounded-3xl p-6 sm:p-8 max-w-2xl mx-auto border-2 border-rh-orange/30">
              ...
              <p className="text-sm sm:text-base text-rh-white/90 mb-6">
                Spaces are filling up fast! Register now for Code & Create 2026
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 animate-fade-scale">
            ...
            <div className="glass rounded-2xl p-5 sm:p-6 hover:scale-105 transition-all duration-500 hover:shadow-xl">
              ...
              <p className="text-rh-white/80 text-xs sm:text-sm leading-relaxed">
                ...
                Rocketry Club and Formula SAE Team.
              </p>
            </div>
            ...
            <div className="glass rounded-2xl p-5 sm:p-6 hover:scale-105 transition-all duration-500 hover:shadow-xl">
              ...
              <p className="text-rh-white/80 text-xs sm:text-sm leading-relaxed">
                Partnering with KoolKatScience, students learned programming
                through Scratch, covering logic, loops, and interactivity in a
                creative, beginner-friendly way.
              </p>
            </div>
            ...
            <div className="glass rounded-2xl p-5 sm:p-6 hover:scale-105 transition-all duration-500 hover:shadow-xl">
              ...
              <p className="text-rh-white/80 text-xs sm:text-sm leading-relaxed">
                Students brainstormed and built interactive projects using
                Scratch. The RocketHacks Tech Team provided one-on-one
                mentorship for debugging and refinement.
              </p>
            </div>
            ...
            <div className="glass rounded-2xl p-5 sm:p-6 hover:scale-105 transition-all duration-500 hover:shadow-xl">
              ...
              <p className="text-rh-white/80 text-xs sm:text-sm leading-relaxed">
                Students presented final projects to judges. Dr. Sammy Spann
                congratulated participants, with Nehemia winning for a
                multi-level interactive game with over 40 stages!
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="animate-fade-scale">
              <div className="glass-strong rounded-3xl p-6 sm:p-8 text-center">
                ...
                <p className="text-sm sm:text-base text-rh-white/90 mb-6 leading-relaxed">
                  Code & Create 2026 is in development! Fill out our interest
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 animate-fade-scale">
            <div className="glass rounded-2xl p-5 sm:p-6 text-center">
              ...
              <p className="text-rh-white/80 text-xs sm:text-sm">

...
import {
  ...
  groupMissingFieldsByCategory,
  getCategoryDisplayName,
  type CompletenessResult,
} from "@/lib/utils/applicationCompleteness";
...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen relative py-16 px-4">
      ...
      <div
        className="fixed right-[8%] top-[25%] w-6 h-6 bg-rh-orange rounded-full animate-float opacity-40"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="fixed left-[10%] bottom-[20%] w-3 h-3 bg-rh-purple-light rounded-full animate-float opacity-70"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="fixed right-[6%] bottom-[15%] w-5 h-5 bg-rh-pink rounded-full animate-float opacity-50"
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="glass rounded-2xl p-8 mb-6 animate-slide-up">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            <div>
              <h1
                className={`${terminal.className} text-4xl md:text-5xl font-bold gradient-text uppercase tracking-wider mb-2`}
              >
                Dashboard
              </h1>
        ...
        {application ? (
          ...
          >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <div
                        className={`text-3xl font-bold ${completeness.isComplete ? "text-green-400" : "text-yellow-400"}`}
                      >
                ...
                {!completeness.isComplete && showMissingFields && (
                  <div className="mt-6 space-y-4 animate-slide-down">
                    <div className="border-t border-white/10 pt-4">
                      <h4
                        className={`${terminal.className} text-sm font-semibold text-rh-orange uppercase tracking-wide mb-3`}
                      >
                      ...
                      <div className="space-y-3">
                        {Object.entries(
                          ...
                          >
                            <h5 className="text-sm font-semibold text-rh-yellow mb-2">
                            ...
                            <ul className="space-y-1">
                              {fields.map((field) => (
                                <li
                                  key={field.field}
                                  className="text-sm text-rh-white/70 flex items-start gap-2"
                                >
                                  <span className="text-rh-orange mt-0.5">
                                    •
                                  </span>
            ...
            <div className="glass rounded-2xl p-8">
              <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-6">
                <div>
                  <h2
                    className={`${terminal.className} text-2xl md:text-3xl font-semibold text-rh-yellow uppercase tracking-wide mb-2`}
                  >
                    Application Status
                  </h2>
                  <p className="text-rh-white/70">
                    Submitted on{" "}
                    {new Date(application.submitted_at).toLocaleDateString()}
                  </p>
                </div>
                <span
                  className={`px-4 py-2 rounded-lg border font-semibold uppercase text-sm backdrop-blur-sm ${getStatusColor(application.status)}`}
                >
                  {application.status}
                </span>
              </div>
              ...
              {application.status === "pending" && (
                <div className="bg-rh-yellow/10 border border-rh-yellow/50 text-rh-yellow px-6 py-4 rounded-xl backdrop-blur-sm">
                  <p
                    className={`${terminal.className} font-semibold mb-2 text-lg`}
                  >
              ...
              {application.status === "accepted" && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {/* Acceptance Card */}
                  <div
                    className="relative rounded-2xl backdrop-blur-xl overflow-hidden border-2 border-green-500/40 shadow-2xl"
                    style={{
                      background:
                  ...
                  >
                    ...
                    <div className="relative p-6 sm:p-8">
                      ...
                      <div className="space-y-3">
                        <div>
                          <h3
                            className={`${terminal.className} text-2xl sm:text-3xl font-bold text-green-400 uppercase tracking-wide mb-2`}
                          >
                            Accepted!
                          </h3>
                        ...
                        <p className="text-sm sm:text-base text-rh-white/80 leading-relaxed">
                          Be on the lookout for an email for next steps and
                  ...
                  {/* Check-In Badge Card */}
                  <div
                    className={`relative rounded-2xl backdrop-blur-xl overflow-hidden border-2 shadow-2xl ${
                  ...
                  >
                    ...
                    <div className="relative p-6 sm:p-8">
                      {/* Badge Icon */}
                      <div
                        className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl border-2 mb-4 shadow-lg ${
                          application.checked_in
                      ...
                      <div className="space-y-3">
                        <div>
                          <h3
                            className={`${terminal.className} text-2xl sm:text-3xl font-bold uppercase tracking-wide mb-2 ${
                              application.checked_in
                                ? "text-blue-400"
                                : "text-yellow-400"
                            }`}
                        ...
                        {application.checked_in ? (
                          <>
                            <p className="text-sm sm:text-base text-rh-white/80 leading-relaxed">
                              Show this badge to organizers at the event for
                              verification.
                            </p>
                            ...
                            <div className="mt-6 p-6 rounded-xl bg-white/5 border border-blue-400/30 backdrop-blur-sm">
                              <div className="flex flex-col items-center justify-center space-y-3">
                                ...
                                <div className="text-center">
                                  <p
                                    className={`${terminal.className} text-xl font-bold text-blue-300 uppercase tracking-wider`}
                                  >
                                ...
                                <div className="pt-2 text-center">
                                  <p className="text-xs text-blue-300/60 uppercase tracking-wide mb-1">
                                    Checked In
                                  </p>
                          ...
                          <>
                            <p className="text-sm sm:text-base text-rh-white/80 leading-relaxed">
                              You will be checked in when you arrive at the
                              event. See you there!
                            </p>
                            ...
                            <div className="mt-6 p-6 rounded-xl bg-white/5 border border-yellow-400/30 backdrop-blur-sm">
                              <div className="flex flex-col items-center justify-center space-y-3 opacity-50">
                                <div className="w-20 h-20 rounded-full bg-yellow-500/20 border-4 border-yellow-400/40 flex items-center justify-center">
                                  <svg
                                    className="w-12 h-12 text-yellow-300/60"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                  >
                  ...
                  <a
                    ...
                    className="relative rounded-2xl backdrop-blur-xl overflow-hidden border-2 border-indigo-500/40 shadow-2xl lg:col-span-2 hover:border-indigo-500/60 transition-all duration-300 group"
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(79, 70, 229, 0.15) 0%, rgba(67, 56, 202, 0.08) 100%)",
                    }}
                  >
                    {/* Decorative gradient overlay */}
                    <div className="absolute inset-0 bg-gradient-to-br from-indigo-400/5 via-transparent to-indigo-600/10 pointer-events-none"></div>

                    <div className="relative p-6 sm:p-8">
                      {/* Icon Badge */}
                      <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-indigo-500/20 border-2 border-indigo-400/40 mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
                        <Image
                          src="/assets/rh_26/discord-black-icon.png"
                          alt="Discord"
                          width={36}
                          height={36}
                          className="w-9 h-9"
                      ...
                      <div className="space-y-3">
                        <div>
                          <h3
                            className={`${terminal.className} text-2xl sm:text-3xl font-bold text-indigo-400 uppercase tracking-wide mb-2`}
                          >
                            Join Our Discord
                          </h3>
                          <p className="text-indigo-300/90 text-base sm:text-lg font-semibold">
                            Official Communications Hub for everything
                            RocketHacks!
                          </p>
                        </div>
                        ...
                        <p className="text-sm sm:text-base text-rh-white/80 leading-relaxed">
                          Discord is your main hub for connecting with fellow
                          hackers, mentors, and our organizing team. All
                          official event announcements and important updates
                          will be shared there—make sure to join and stay
                          active!
                        </p>

                        {/* CTA Button */}
                        <div className="pt-4">
                          <span className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/30 group-hover:bg-indigo-500/50 transition-colors rounded-lg border border-indigo-400/50 text-indigo-300">
                            <svg
                              className="w-5 h-5"
                              fill="currentColor"
                              viewBox="0 0 24 24"
                            >
                              <path d="M20.317 4.37a19.791 19.791 0 00-4.885-1.515.074.074 0 00-.079.037c-.21.375-.444.864-.607 1.25a18.27 18.27 0 00-5.487 0c-.163-.386-.395-.875-.607-1.25a.077.077 0 00-.079-.037A19.736 19.736 0 003.677 4.37a.07.07 0 00-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 00.031.057 19.9 19.9 0 005.993 3.03.078.078 0 00.084-.028c.462-.63.873-1.295 1.226-1.994a.076.076 0 00-.041-.106 13.107 13.107 0 01-1.872-.892.077.077 0 01-.008-.128 10.2 10.2 0 00.372-.294.075.075 0 01.078-.01c3.928 1.793 8.18 1.793 12.062 0a.075.075 0 01.079.009c.12.098.246.198.373.294a.077.077 0 01-.006.127 12.299 12.299 0 01-1.873.892.076.076 0 00-.041.107c.36.699.77 1.364 1.225 1.994a.078.078 0 00.084.028 19.839 19.839 0 006.002-3.03.077.077 0 00.032-.057c.5-4.761-.838-8.898-3.549-12.562a.06.06 0 00-.031-.028zM8.02 15.33c-1.183 0-2.157-.965-2.157-2.156 0-1.193.96-2.157 2.157-2.157 1.206 0 2.176.964 2.157 2.157 0 1.19-.97 2.157-2.157 2.157zm7.975 0c-1.183 0-2.157-.965-2.157-2.156 0-1.193.96-2.157 2.157-2.157 1.206 0 2.176.964 2.157 2.157 0 1.19-.97 2.157-2.157 2.157z" />
                            </svg>
                            Join Discord
                          </span>
                        </div>
              ...
              {application.status === "waitlisted" && (
                <div className="bg-rh-purple-light/10 border border-rh-purple-light/50 text-rh-purple-light px-6 py-4 rounded-xl backdrop-blur-sm">
                  ...
                  <p className="text-sm text-rh-white/80">
                    We'll notify you if a spot becomes available. Keep an eye on
                    your email!
                  </p>
                </div>
              )}
            ...
            >
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
                <h2
                  className={`${terminal.className} text-2xl md:text-3xl font-semibold text-rh-yellow uppercase tracking-wide`}
                >
                  Your Application
                </h2>
                <Link
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-rh-white/90">
                <div>
                  <h3
                    className={`${terminal.className} text-lg font-semibold text-rh-orange uppercase tracking-wide mb-3`}
                  >
                    Personal Information
                  </h3>
                  <div className="space-y-2 text-sm">
                    <p>
                      <span className="text-rh-white/60">Name:</span>{" "}
                      {application.first_name} {application.last_name}
                    </p>
                    {application.phone_number && (
                      <p>
                        <span className="text-rh-white/60">Phone:</span>{" "}
                        {application.phone_number}
                      </p>
                    )}
                    {application.age && (
                      <p>
                        <span className="text-rh-white/60">Age:</span>{" "}
                        {application.age}
                      </p>
                    )}
                    {application.country_of_residence && (
                      <p>
                        <span className="text-rh-white/60">Country:</span>{" "}
                        {application.country_of_residence}
                      </p>
                    )}
                    {application.gender && (
                      <p>
                        <span className="text-rh-white/60">Gender:</span>{" "}
                        {application.gender}
                      </p>
                    )}
                    {application.pronouns && (
                      <p>
                        <span className="text-rh-white/60">Pronouns:</span>{" "}
                        {application.pronouns}
                      </p>
                    )}
                  </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <p>
                      <span className="text-rh-white/60">School:</span>{" "}
                      {application.school}
                    </p>
                    {application.major && (
                      <p>
                        <span className="text-rh-white/60">Major:</span>{" "}
                        {application.major}
                      </p>
                    )}
                    {application.level_of_study && (
                      <p>
                        <span className="text-rh-white/60">Level:</span>{" "}
                        {application.level_of_study}
                      </p>
                    )}
                  </div>
                    ...
                    {application.github_url && (
                      <p>
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-rh-yellow hover:text-rh-orange transition-colors underline"
                        >
                          {application.github_url}
                        </a>
                      </p>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <p>
                      <span className="text-rh-white/60">First Hackathon:</span>{" "}
                      {application.first_hackathon ? "Yes" : "No"}
                    </p>
                    {application.team_name && (
                      <p>
                        <span className="text-rh-white/60">Team:</span>{" "}
                        {application.team_name}
                      </p>
                    )}
                    {application.tshirt_size && (
                      <p>
                        <span className="text-rh-white/60">T-Shirt:</span>{" "}
                        {application.tshirt_size}
                      </p>
                    )}
                    {application.dietary_restrictions && (
                      <p>
                        <span className="text-rh-white/60">Dietary:</span>{" "}
                        {Array.isArray(application.dietary_restrictions)
                          ? application.dietary_restrictions.join(", ")
                          : application.dietary_restrictions}
                      </p>
                    )}
                  </div>
          ...
          <div className="glass rounded-2xl p-12 text-center animate-slide-up">
            <h2
              className={`${terminal.className} text-3xl md:text-4xl font-semibold gradient-text uppercase tracking-wider mb-4`}
            >
              No Application Found
            </h2>
            <p className="text-rh-white/70 mb-8 text-lg">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <h3
              className={`${terminal.className} text-lg font-semibold text-rh-yellow group-hover:text-rh-orange transition-colors mb-2 uppercase tracking-wide`}
            >
              ← Back to Home
            </h3>

...
export default function Hero() {
  ...
  // Small "loading" animation without extra dependencies.
  useEffect(() => {
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="RocketHacks 2027 Background"
            fill
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                <span className="inline-flex items-center gap-3">
                  <span
                    aria-hidden="true"
                    className="inline-block w-5 h-5 rounded-full border-2 border-rh-yellow/25 border-t-rh-yellow animate-spin"
                  />
                  Details Loading{dots}
                </span>
              </h3>
              <div
          ...
          <div
            className="absolute left-[5%] w-4 h-4 bg-rh-yellow rounded-full animate-float opacity-60"
            style={{ top: "max(120px, 12vh)" }}
          ></div>
          <div
            className="absolute right-[10%] w-6 h-6 bg-rh-orange rounded-full animate-float opacity-40"
            style={{ top: "max(160px, 18vh)", animationDelay: "1s" }}
          ></div>
          <div
            className="absolute left-[10%] w-3 h-3 bg-rh-purple-light rounded-full animate-float opacity-70 hidden md:block"
            style={{ bottom: "max(120px, 12vh)", animationDelay: "2s" }}
          ></div>
          <div
            className="absolute right-[5%] w-5 h-5 bg-rh-pink rounded-full animate-float opacity-50 hidden md:block"
            style={{ bottom: "max(80px, 8vh)", animationDelay: "0.5s" }}
          ></div>
        </div>
      </section>
    </div>
